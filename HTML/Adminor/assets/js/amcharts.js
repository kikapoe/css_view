...
$(function(e) {
	...
	AmCharts.ready(function() {
		...
		distanceGraph.lineColor = "#6c3e9d";
		...
		latitudeGraph.lineColor = "#ff7e5f";
		...
		latitudeGraph.bulletBorderColor = "#ff7e5f";
		latitudeGraph.bulletBorderAlpha = 1;
		latitudeGraph.bulletBorderThickness = 2;
		latitudeGraph.bulletColor = "#ff7e5f";
